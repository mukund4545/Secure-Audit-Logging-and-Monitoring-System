...
/** INTERFACE IMPLEMENTATION: implements BaseDAO<UserEvent> */
public class UserEventDAO implements BaseDAO<UserEvent> {
    ...
    @Override
    public List<UserEvent> getByUserId(int userId) throws SQLException {
        List<UserEvent> list = new ArrayList<>();
