...
/** INTERFACE IMPLEMENTATION: implements BaseDAO<Session> */
public class SessionDAO implements BaseDAO<Session> {

    /** BaseDAO contract: insert = createSession */
    @Override
    public boolean insert(Session s) throws SQLException {
    ...
    @Override
    public List<Session> getByUserId(int userId) throws SQLException {
        List<Session> list = new ArrayList<>();
